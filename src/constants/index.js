...
const testimonials = [
  {
    testimonial:
      "This Course provides a comprehensive introduction to programming using the Java language. It is designed to equip us with foundational skills necessary to understand and write basic Java programs.",
